...
export default class YouTube extends React.Component {
  ...
  playVideo() {
    UIManager.dispatchViewManagerCommand(
      ...
      UIManager.getViewManagerConfig('ReactYouTube').Commands.playVideo,
      [],
    );
  }
  ...
  stopVideo() {
    UIManager.dispatchViewManagerCommand(
      ReactNative.findNodeHandle(this._nativeComponentRef.current),
      UIManager.getViewManagerConfig('ReactYouTube').Commands.stopVideo,
      [],
    );
  }
  ...
  pauseVideo() {
    UIManager.dispatchViewManagerCommand(
      ReactNative.findNodeHandle(this._nativeComponentRef.current),
      UIManager.getViewManagerConfig('ReactYouTube').Commands.pauseVideo,
      [],
    );
  }
